...
pagenumbers=input("Starting pages you want enter: ")
pagenumber=int(pagenumbers)
pagenumber2=input("Starting pages you want enter: ")
pagenumbers2=int(pagenumber2)
pagename=input('Enter website basic URL with replacement changes URL : ')
...
for s in range(pagenumber,pagenumbers2+1):
    for i in range(page1,page2+1):
        variable_find=input('Enter variable Name get in url : ')        
        variable_rplace=input('Enter variable Name want to replace : ')        
        p=pagename.find(variable_change)
        if(p>1):
            newpage=pagename.replace(variable_change,variable_rplace+str(i)+'&')
            browser.get(newpage)
            time.sleep(3)
        else:
...
price_tag=input("Enter Price Tag: ")
price_web=input("Enter Price: ")
sku_tag=input("Enter SKU Tag: ")
sku_web=input("Enter SKU: ")
title_tag=input("Enter Title Tag: ")
title_web=input("Enter Title: ")
shortdesc_tag=input("Enter Short Description Tag: ")
shortdesc_web=input("Enter Short Description: ")
desc_tag=input("Enter Description Tag: ")
desc_web=input("Enter Description: ")
brand_tag=input("Enter Brand Tag: ")
brand_web=input("Enter Brand: ")
promo_pc_tag=input("Enter Promotion Price Tag: ")
promo_pc_web=input("Enter Promotion Price: ")
breadcum_pc_tag=input("Enter Breadcrumb Tag : ")
breadcum_pc_web=input("Enter Breadcrumb : ")
catgory_tag=input("Enter Category Tag: ")
catgory_web=input("Enter Category : ")
sizess_tag=input("Enter Sizes Tag: ")
sizess_web=input("Enter Sizes : ")
colrs_tag=input("Enter Colors Tag : ")
colrs_web=input("Enter Colors : ")
